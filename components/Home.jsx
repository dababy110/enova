        ...
        >
          <View>
            <View style={{ alignItems: "center" }}>
              ...
              <Text style={{ textAlign: "center", width: 280, fontSize: 16 }}>
...
const ChooseTools = () => {
  ...
  return (
    ...
    >
      <Text style={{ fontSize: 25, fontWeight: 500, margin: 20 }}>
        Elige la funcion que quieres utilizar:{" "}
      </Text>
      <View style={{ gap: 30, alignItems: "center", justifyContent: "center" }}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate("ImageDetector")}
          style={{
